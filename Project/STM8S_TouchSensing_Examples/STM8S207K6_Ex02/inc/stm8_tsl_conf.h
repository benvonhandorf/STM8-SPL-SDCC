/**
  ******************************************************************************
  * @file    STM8S207K6_Ex02\inc\stm8_tsl_conf.h
...
#define SCKEY_P2_DRIVEN_SHIELD_MASK (0x80)
...
#define MCKEY1_DRIVEN_SHIELD_MASK (0x00) // Connected to PD7 = LED1...
...
// Thresholds
#define SCKEY_DETECTTHRESHOLD_DEFAULT          (12)  /**< Single channel key detection threshold (value from 1 to 127) */
...
#define MCKEY_DETECTTHRESHOLD_DEFAULT          (80)  /**< Multi channel key detection threshold (value from 1 to 127) */
#define MCKEY_ENDDETECTTHRESHOLD_DEFAULT       (60)  /**< Multi channel key end detection threshold (value from 1 to 127) */
#define MCKEY_RECALIBRATIONTHRESHOLD_DEFAULT  (-60)  /**< Multi channel key calibration threshold (value from -1 to -128) */

// MCKey resolution
#define MCKEY_RESOLUTION_DEFAULT                   (5)  /**< Multi channel key resolution (value from 1 to 8) */
...
#define MCKEY_DIRECTION_CHANGE_THRESHOLD_DEFAULT    (30)  /**< Multi channel key direction change threshold (value from 1 to 255) */
...
#define MCKEY1_DELTA_COEFF_A (0x012D) /**< MCKey1 Channel A parameter */
#define MCKEY1_DELTA_COEFF_B (0x0109) /**< MCKey1 Channel B parameter */
#define MCKEY1_DELTA_COEFF_C (0x0100) /**< MCKey1 Channel C parameter */
#define MCKEY1_DELTA_COEFF_D (0x0114) /**< MCKey1 Channel D parameter */
#define MCKEY1_DELTA_COEFF_E (0x014D) /**< MCKey1 Channel E parameter */
